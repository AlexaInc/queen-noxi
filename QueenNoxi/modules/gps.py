...
@queennoxi.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        geolocator = Nominatim(user_agent="legend-QueenNoxi")
#         zoom=[0-18]
...
@queennoxi.on_message(filters.command(["distance"]))
...
# queennoxi.add_handler(MessageHandler(gps))     
# queennoxi.add_handler(MessageHandler(distance))
