...
from QueenNoxi import OWNER_ID, pbot
from QueenNoxi.utils.admins import can_change_info
from QueenNoxi.utils.errors import capture_err
from QueenNoxi.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|queennoxi|thank you|gud|thankyou|love|pro)$"
