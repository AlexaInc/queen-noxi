...
CleanerBlueTextChatSettings.__table__.create(BASE.metadata.bind, checkfirst=True)
CleanerBlueTextChat.__table__.create(BASE.metadata.bind, checkfirst=True)
CleanerBlueTextGlobal.__table__.create(BASE.metadata.bind, checkfirst=True)
