...
ChatAccessConnectionSettings.__table__.create(BASE.metadata.bind, checkfirst=True)
Connection.__table__.create(BASE.metadata.bind, checkfirst=True)
ConnectionHistory.__table__.create(BASE.metadata.bind, checkfirst=True)
