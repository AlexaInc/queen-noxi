...
Federations.__table__.create(BASE.metadata.bind, checkfirst=True)
ChatF.__table__.create(BASE.metadata.bind, checkfirst=True)
BansF.__table__.create(BASE.metadata.bind, checkfirst=True)
FedsUserSettings.__table__.create(BASE.metadata.bind, checkfirst=True)
FedSubs.__table__.create(BASE.metadata.bind, checkfirst=True)
