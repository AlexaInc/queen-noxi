...
from QueenNoxi import BOT_ID, BOT_USERNAME
...
Users.__table__.create(BASE.metadata.bind, checkfirst=True)
Chats.__table__.create(BASE.metadata.bind, checkfirst=True)
ChatMembers.__table__.create(BASE.metadata.bind, checkfirst=True)
