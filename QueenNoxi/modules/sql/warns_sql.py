...
Warns.__table__.create(BASE.metadata.bind, checkfirst=True)
WarnFilters.__table__.create(BASE.metadata.bind, checkfirst=True)
WarnSettings.__table__.create(BASE.metadata.bind, checkfirst=True)
