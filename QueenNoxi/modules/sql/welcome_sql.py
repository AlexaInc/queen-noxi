...
from QueenNoxi.modules.helper_funcs.msg_types import Types
...
Welcome.__table__.create(BASE.metadata.bind, checkfirst=True)
WelcomeButtons.__table__.create(BASE.metadata.bind, checkfirst=True)
GoodbyeButtons.__table__.create(BASE.metadata.bind, checkfirst=True)
