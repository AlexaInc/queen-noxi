...
@queennoxi.on_message(filters.command(["short"]))
...
@queennoxi.on_message(filters.command(["unshort"]))
...
# queennoxi.add_handler(MessageHandler(short_urls))
# queennoxi.add_handler(MessageHandler(unshort))
__help__ = """
